    ...
    <div class="row">
      <div class="col">
        <div class="card card-body bg-primary text-white mt-5">
          <h2 class="midle">Maurein Acabal Sibunga</h2>
            ...
            <div class="card border border-light">
              <img class="rounded card-img-top border border-dark" src="image/3.jpg" alt="Card image cap">
                <div class="card-body" style="padding: 5px;">
                    <h5 class="card-title" style="margin-bottom: 1px; text-align: left;"><a class="text-primary" href="indexfq.php">Famous Quotes</a></h5>
                    <small class="text-primary">The website is list of Popular quotes in the social media. </small>
		</div>
    </div>
